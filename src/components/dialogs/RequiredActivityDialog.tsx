...
const RequiredActivityDialog = ({ tool, level }: RequiredActivityDialogProps) => {
  ...
  // Check if this is the very first tool the user has seen (MS Teams)
      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader className="text-center space-y-4">
          ...
          <DialogTitle className="text-2xl">
            {isFirstTool && !hasSeenAnyBefore ? "About Your Required Activities" : "Reminder: Required Activities"}
          </DialogTitle>
          <DialogDescription className="text-base">
            {isFirstTool && !hasSeenAnyBefore ? (
              <>
                Each module includes a <strong>required Edpuzzle activity</strong> that you must complete. Your completion of these activities is recorded as evidence of your digital learning journey at Bradford College.
              </>
            ) : (
              <>
                Don't forget to complete the <strong>required Edpuzzle activity</strong> in this module — it's recorded as part of your digital journey evidence.
              </>
            )}
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-3 py-2">
            <div className="flex items-start gap-3 bg-secondary/30 rounded-lg p-3">
              ...
              <p className="text-sm text-muted-foreground">
                The embedded questions within the Edpuzzle videos will be compiled as <strong>proof of your engagement</strong> with the training content. Make sure to answer them thoughtfully.
              </p>
            </div>
            <div className="flex items-start gap-3 bg-secondary/30 rounded-lg p-3">
