...
export const learningObjectives: Record<Level, ToolObjectives[]> = {
  explorer: [
    ...
    },
    {
      ...
      toolName: 'Canva Code',
      objectives: [
        { id: 'ca1', text: 'Use Canva to design clear, visually engaging teaching resources that are accessible to all learners', description: 'Create professional resources using Canva\'s design tools with accessibility in mind' },
        { id: 'ca2', text: 'Apply Canva\'s accessibility features to create materials that reduce cognitive overload and support learners with diverse needs', description: 'Use contrast checkers, readable fonts, and clear layouts to support all learners' },
        { id: 'ca3', text: 'Use Canva Code to begin creating simple interactive learning activities that increase learner engagement and participation', description: 'Add interactive elements like buttons and input fields to make activities engaging' },
        { id: 'ca4', text: 'Design contextualised learning activities that reflect the real-world contexts relevant to your learners at Bradford College', description: 'Create activities tailored to your specific vocational or academic context' },
        { id: 'ca5', text: 'Create resources that enhance the student learning experience through visual clarity, interactivity, and inclusive design', description: 'Build resources that combine visual appeal with accessibility and engagement' },
      ],
    },
  ],
  practitioner: [
    ...
    },
    {
      ...
      objectives: [
        { id: 'cp1', text: 'Create basic designs', description: 'Build visually appealing resources from scratch using Canva\'s design tools' },
        { id: 'cp2', text: 'Build interactive learning activities using Canva Code', description: 'Use Canva\'s coding feature to create engaging, interactive student experiences' },
        { id: 'cp3', text: 'Adapt activities for different learners', description: 'Modify resources to meet diverse learning needs and accessibility requirements' },
      ],
    },
    {
      tool: 'copilot',
    ...
    },
    {
      ...
      objectives: [
        { id: 'ip1', text: 'Explore the Immersive Room via the 360° guide', description: 'Familiarise yourself with the room, its functions, and available systems using the interactive tour' },
        { id: 'ip2', text: 'Book training and plan your session', description: 'Attend Immersive Room training, then design a session that uses the room\'s capabilities for your curriculum' },
        { id: 'ip3', text: 'Deliver 2-3 immersive sessions', description: 'Use the Immersive Room with your learners, reflect on what worked and what to improve, then deliver again' },
        { id: 'ip4', text: 'Share best practice with colleagues', description: 'Share a lesson plan, talk through your session, or post on the Padlet to help others learn from your experience' },
      ],
    },
  ],
  leader: [
