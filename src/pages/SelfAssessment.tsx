          ...
          <Card className="border-accent shadow-[var(--shadow-card)]">
            ...
            <CardContent>
              ...
              <div className="mt-4 p-4 bg-muted/50 rounded-lg border border-border">
                ...
                <a 
                  href="https://www.canva.com/design/DAXD0X3v8nA/DX4fP6bEhcfiFHpH4plQvA/view?utm_content=DAXD0X3v8nA&utm_campaign=designshare&utm_medium=embeds&utm_source=link"
                  target="_blank"
